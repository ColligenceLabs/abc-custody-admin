/**
 * Individual Members Onboarding Table
 * 개인 회원 온보딩 테이블 컴포넌트
 */
...
import { IndividualOnboardingApplication } from "@/data/types/individualOnboarding";
import { getApplicantId } from "@/data/types/onboardingUnified";
import { IndividualReviewDialog } from "./IndividualReviewDialog";

interface IndividualApplicationsTableProps {
  applications: IndividualOnboardingApplication[];
}
...
export function IndividualApplicationsTable({ applications }: IndividualApplicationsTableProps) {
  ...
  const filteredApplications = applications.filter(app => {
    const matchesSearch =
      ...
      app.personalInfo.idNumber.includes(searchQuery);
    ...
    <>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {filteredApplications.length}건의 개인 회원 신청이 있습니다
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
