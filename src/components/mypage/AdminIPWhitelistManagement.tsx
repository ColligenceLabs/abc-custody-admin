...
export default function AdminIPWhitelistManagement({
  isVisible,
  onClose,
}: AdminIPWhitelistManagementProps) {
  ...
  const handleAddIP = () => {
    ...
    const existingIP = whitelistEntries.find(
      (entry) => entry.ipRange === newIP.ipRange
    );
    if (existingIP) {
          ...
          <div className="flex items-start">
            ...
            <div className="text-sm">
              ...
              <ul className="text-gray-700 space-y-1 list-disc list-inside">
                <li>모든 IP 대역을 삭제하면 접근이 불가능할 수 있습니다.</li>
                <li>
                  CIDR 표기법을 사용하여 네트워크 대역을 효율적으로 관리하세요.
                </li>
          ...
          >
            ...
            <div>
              ...
              <input
                ...
                value={newIP.ipRange}
                onChange={(e) =>
                  setNewIP({ ...newIP, ipRange: e.target.value })
                }
